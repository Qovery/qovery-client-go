...
type ApiEditEnvironmentDeployemtnRuleRequest struct {
...
func (r ApiEditEnvironmentDeployemtnRuleRequest) EnvironmentDeploymentRuleEditRequest(environmentDeploymentRuleEditRequest EnvironmentDeploymentRuleEditRequest) ApiEditEnvironmentDeployemtnRuleRequest {
	r.environmentDeploymentRuleEditRequest = &environmentDeploymentRuleEditRequest
	return r
}

func (r ApiEditEnvironmentDeployemtnRuleRequest) Execute() (EnvironmentDeploymentRuleResponse, *_nethttp.Response, error) {
	return r.ApiService.EditEnvironmentDeployemtnRuleExecute(r)
}

/*
 * EditEnvironmentDeployemtnRule Edit an environment deployment rule
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param environmentId Environment ID
 * @param deploymentRuleId Deployment Rule ID
 * @return ApiEditEnvironmentDeployemtnRuleRequest
 */
func (a *EnvironmentDeploymentRuleApiService) EditEnvironmentDeployemtnRule(ctx _context.Context, environmentId string, deploymentRuleId string) ApiEditEnvironmentDeployemtnRuleRequest {
	return ApiEditEnvironmentDeployemtnRuleRequest{
		ApiService:       a,
		ctx:              ctx,
 ...
 */
func (a *EnvironmentDeploymentRuleApiService) EditEnvironmentDeployemtnRuleExecute(r ApiEditEnvironmentDeployemtnRuleRequest) (EnvironmentDeploymentRuleResponse, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EnvironmentDeploymentRuleApiService.EditEnvironmentDeployemtnRule")
	if err != nil {
