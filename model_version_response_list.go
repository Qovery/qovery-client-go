...
// checks if the VersionResponseList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VersionResponseList{}
...
func (o VersionResponseList) ToMap() (map[string]interface{}, error) {
