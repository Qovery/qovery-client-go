...
// checks if the MetricMemoryDatapointResponseList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MetricMemoryDatapointResponseList{}
...
type MetricMemoryDatapointResponseList struct {
	Results []MetricMemoryDatapoint `json:"results,omitempty"`
}
...
// SetResults gets a reference to the given []MetricMemoryDatapoint and assigns it to the Results field.
...
func (o MetricMemoryDatapointResponseList) ToMap() (map[string]interface{}, error) {
