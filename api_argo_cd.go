...
type ApiGetArgoCdAppManifestRequest struct {
	ctx         context.Context
	ApiService  *ArgoCDAPIService
	argocdAppId string
}

func (r ApiGetArgoCdAppManifestRequest) Execute() (*ArgocdAppManifestResponse, *http.Response, error) {
	return r.ApiService.GetArgoCdAppManifestExecute(r)
}

/*
GetArgoCdAppManifest Get ArgoCD app manifest enrichment

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param argocdAppId ArgoCD App ID
	@return ApiGetArgoCdAppManifestRequest
*/
func (a *ArgoCDAPIService) GetArgoCdAppManifest(ctx context.Context, argocdAppId string) ApiGetArgoCdAppManifestRequest {
	return ApiGetArgoCdAppManifestRequest{
		ApiService:  a,
		ctx:         ctx,
		argocdAppId: argocdAppId,
...
// Execute executes the request
//
//	@return ArgocdAppManifestResponse
func (a *ArgoCDAPIService) GetArgoCdAppManifestExecute(r ApiGetArgoCdAppManifestRequest) (*ArgocdAppManifestResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *ArgocdAppManifestResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ArgoCDAPIService.GetArgoCdAppManifest")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/argocdApp/{argocdAppId}/manifest"
	localVarPath = strings.Replace(localVarPath, "{"+"argocdAppId"+"}", url.PathEscape(parameterValueToString(r.argocdAppId, "argocdAppId")), -1)
...
type ApiGetArgoCdAssociatedServicesRequest struct {
	ctx        context.Context
	ApiService *ArgoCDAPIService
	clusterId  string
}

func (r ApiGetArgoCdAssociatedServicesRequest) Execute() (*ArgocdAssociatedServicesResponseList, *http.Response, error) {
	return r.ApiService.GetArgoCdAssociatedServicesExecute(r)
}

/*
GetArgoCdAssociatedServices Get ArgoCD associated services for a cluster
...
List the ArgoCD discovered apps for a cluster, mapped to their project, environment, and service context. Requires VIEWER role.
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param clusterId Cluster ID
	@return ApiGetArgoCdAssociatedServicesRequest
*/
func (a *ArgoCDAPIService) GetArgoCdAssociatedServices(ctx context.Context, clusterId string) ApiGetArgoCdAssociatedServicesRequest {
	return ApiGetArgoCdAssociatedServicesRequest{
		ApiService: a,
		ctx:        ctx,
		clusterId:  clusterId,
...
// Execute executes the request
//
//	@return ArgocdAssociatedServicesResponseList
func (a *ArgoCDAPIService) GetArgoCdAssociatedServicesExecute(r ApiGetArgoCdAssociatedServicesRequest) (*ArgocdAssociatedServicesResponseList, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *ArgocdAssociatedServicesResponseList
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ArgoCDAPIService.GetArgoCdAssociatedServices")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/cluster/{clusterId}/argocdApps/associatedServices"
	localVarPath = strings.Replace(localVarPath, "{"+"clusterId"+"}", url.PathEscape(parameterValueToString(r.clusterId, "clusterId")), -1)
