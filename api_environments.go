...
type ApiGetProjectEnvironmentsOverviewRequest struct {
	ctx        context.Context
	ApiService *EnvironmentsAPIService
	projectId  string
}

func (r ApiGetProjectEnvironmentsOverviewRequest) Execute() (*EnvironmentOverviewResponseList, *http.Response, error) {
	return r.ApiService.GetProjectEnvironmentsOverviewExecute(r)
}
...
Returns a list of environments with their overview information including deployment status, service count, and cluster details.
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param projectId Project ID
	@return ApiGetProjectEnvironmentsOverviewRequest
*/
func (a *EnvironmentsAPIService) GetProjectEnvironmentsOverview(ctx context.Context, projectId string) ApiGetProjectEnvironmentsOverviewRequest {
	return ApiGetProjectEnvironmentsOverviewRequest{
		ApiService: a,
		ctx:        ctx,
		projectId:  projectId,
...
// Execute executes the request
//
//	@return EnvironmentOverviewResponseList
func (a *EnvironmentsAPIService) GetProjectEnvironmentsOverviewExecute(r ApiGetProjectEnvironmentsOverviewRequest) (*EnvironmentOverviewResponseList, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *EnvironmentOverviewResponseList
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EnvironmentsAPIService.GetProjectEnvironmentsOverview")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/project/{projectId}/environment/overview"
	localVarPath = strings.Replace(localVarPath, "{"+"projectId"+"}", url.PathEscape(parameterValueToString(r.projectId, "projectId")), -1)
...
type ApiGetProjectEnvironmentsOverviewDeprecatedRequest struct {
	ctx        context.Context
	ApiService *EnvironmentsAPIService
	projectId  string
}

func (r ApiGetProjectEnvironmentsOverviewDeprecatedRequest) Execute() (*EnvironmentOverviewResponseListDeprecated, *http.Response, error) {
	return r.ApiService.GetProjectEnvironmentsOverviewDeprecatedExecute(r)
}

/*
GetProjectEnvironmentsOverviewDeprecated List environments overview

Returns a list of environments with their overview information including deployment status, service count, and cluster details.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param projectId Project ID
	@return ApiGetProjectEnvironmentsOverviewDeprecatedRequest
*/
func (a *EnvironmentsAPIService) GetProjectEnvironmentsOverviewDeprecated(ctx context.Context, projectId string) ApiGetProjectEnvironmentsOverviewDeprecatedRequest {
	return ApiGetProjectEnvironmentsOverviewDeprecatedRequest{
		ApiService: a,
		ctx:        ctx,
		projectId:  projectId,
...
// Execute executes the request
//
//	@return EnvironmentOverviewResponseListDeprecated
func (a *EnvironmentsAPIService) GetProjectEnvironmentsOverviewDeprecatedExecute(r ApiGetProjectEnvironmentsOverviewDeprecatedRequest) (*EnvironmentOverviewResponseListDeprecated, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *EnvironmentOverviewResponseListDeprecated
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EnvironmentsAPIService.GetProjectEnvironmentsOverviewDeprecated")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/project/{projectId}/environmentOverview"
	localVarPath = strings.Replace(localVarPath, "{"+"projectId"+"}", url.PathEscape(parameterValueToString(r.projectId, "projectId")), -1)
