...
type ApiEditClusterDnsProviderRequest struct {
	ctx                       context.Context
	ApiService                *ClustersAPIService
	clusterId                 string
...
func (r ApiEditClusterDnsProviderRequest) ClusterDnsProviderRequest(clusterDnsProviderRequest ClusterDnsProviderRequest) ApiEditClusterDnsProviderRequest {
	r.clusterDnsProviderRequest = &clusterDnsProviderRequest
	return r
}

func (r ApiEditClusterDnsProviderRequest) Execute() (*ClusterDnsProviderResponse, *http.Response, error) {
	return r.ApiService.EditClusterDnsProviderExecute(r)
}

/*
EditClusterDnsProvider Edit cluster DNS provider
...
Cloudflare api_token and Route53 STATIC credentials aws_secret_access_key must be provided on every edit.
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param clusterId Cluster ID
	@return ApiEditClusterDnsProviderRequest
*/
func (a *ClustersAPIService) EditClusterDnsProvider(ctx context.Context, clusterId string) ApiEditClusterDnsProviderRequest {
	return ApiEditClusterDnsProviderRequest{
		ApiService: a,
		ctx:        ctx,
		clusterId:  clusterId,
...
// Execute executes the request
//
//	@return ClusterDnsProviderResponse
func (a *ClustersAPIService) EditClusterDnsProviderExecute(r ApiEditClusterDnsProviderRequest) (*ClusterDnsProviderResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPut
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *ClusterDnsProviderResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ClustersAPIService.EditClusterDnsProvider")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/cluster/{clusterId}/dnsProvider"
	localVarPath = strings.Replace(localVarPath, "{"+"clusterId"+"}", url.PathEscape(parameterValueToString(r.clusterId, "clusterId")), -1)

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.clusterDnsProviderRequest == nil {
		return localVarReturnValue, nil, reportError("clusterDnsProviderRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.clusterDnsProviderRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["ApiKeyAuth"]; ok {
...
type ApiGetClusterAnalysisRequest struct {
	ctx        context.Context
	ApiService *ClustersAPIService
	clusterId  string
	analysisId string
...
func (r ApiGetClusterAnalysisRequest) Execute() (*ClusterAnalysisResponse, *http.Response, error) {
	return r.ApiService.GetClusterAnalysisExecute(r)
}

/*
GetClusterAnalysis Get cluster analysis

Returns metadata and status for one cluster analysis execution.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param clusterId Cluster ID
	@param analysisId Cluster analysis ID
	@return ApiGetClusterAnalysisRequest
*/
func (a *ClustersAPIService) GetClusterAnalysis(ctx context.Context, clusterId string, analysisId string) ApiGetClusterAnalysisRequest {
	return ApiGetClusterAnalysisRequest{
		ApiService: a,
		ctx:        ctx,
		clusterId:  clusterId,
...
func (a *ClustersAPIService) GetClusterAnalysisExecute(r ApiGetClusterAnalysisRequest) (*ClusterAnalysisResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *ClusterAnalysisResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ClustersAPIService.GetClusterAnalysis")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/clusters/{clusterId}/analysis/{analysisId}"
	localVarPath = strings.Replace(localVarPath, "{"+"clusterId"+"}", url.PathEscape(parameterValueToString(r.clusterId, "clusterId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"analysisId"+"}", url.PathEscape(parameterValueToString(r.analysisId, "analysisId")), -1)
...
type ApiGetClusterDnsProviderRequest struct {
	ctx        context.Context
	ApiService *ClustersAPIService
	clusterId  string
}

func (r ApiGetClusterDnsProviderRequest) Execute() (*ClusterDnsProviderResponse, *http.Response, error) {
	return r.ApiService.GetClusterDnsProviderExecute(r)
}

/*
GetClusterDnsProvider Get cluster DNS provider

Retrieve the DNS provider currently associated with a cluster. Requires VIEWER role.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param clusterId Cluster ID
	@return ApiGetClusterDnsProviderRequest
*/
func (a *ClustersAPIService) GetClusterDnsProvider(ctx context.Context, clusterId string) ApiGetClusterDnsProviderRequest {
	return ApiGetClusterDnsProviderRequest{
		ApiService: a,
		ctx:        ctx,
		clusterId:  clusterId,
...
//
//	@return ClusterDnsProviderResponse
func (a *ClustersAPIService) GetClusterDnsProviderExecute(r ApiGetClusterDnsProviderRequest) (*ClusterDnsProviderResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ClustersAPIService.GetClusterDnsProvider")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiGetClusterLogsRequest struct {
	ctx        context.Context
	ApiService *ClustersAPIService
	clusterId  string
	endpoint   *string
...
func (r ApiGetClusterLogsRequest) Query(query string) ApiGetClusterLogsRequest {
	r.query = &query
	return r
}

func (r ApiGetClusterLogsRequest) Start(start string) ApiGetClusterLogsRequest {
	r.start = &start
	return r
}

func (r ApiGetClusterLogsRequest) End(end string) ApiGetClusterLogsRequest {
	r.end = &end
	return r
}

func (r ApiGetClusterLogsRequest) Limit(limit string) ApiGetClusterLogsRequest {
	r.limit = &limit
	return r
}

func (r ApiGetClusterLogsRequest) Since(since string) ApiGetClusterLogsRequest {
	r.since = &since
	return r
}

func (r ApiGetClusterLogsRequest) Step(step string) ApiGetClusterLogsRequest {
	r.step = &step
	return r
}

func (r ApiGetClusterLogsRequest) Interval(interval string) ApiGetClusterLogsRequest {
	r.interval = &interval
	return r
}
...
func (r ApiGetClusterLogsRequest) Execute() (*ClusterLogsResponse, *http.Response, error) {
	return r.ApiService.GetClusterLogsExecute(r)
}
...
Fetch cluster logs
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param clusterId
	@return ApiGetClusterLogsRequest
*/
func (a *ClustersAPIService) GetClusterLogs(ctx context.Context, clusterId string) ApiGetClusterLogsRequest {
	return ApiGetClusterLogsRequest{
		ApiService: a,
		ctx:        ctx,
		clusterId:  clusterId,
...
func (a *ClustersAPIService) GetClusterLogsExecute(r ApiGetClusterLogsRequest) (*ClusterLogsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *ClusterLogsResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ClustersAPIService.GetClusterLogs")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/cluster/{clusterId}/logs"
	localVarPath = strings.Replace(localVarPath, "{"+"clusterId"+"}", url.PathEscape(parameterValueToString(r.clusterId, "clusterId")), -1)
...
func (r ApiGetClusterMetricsRequest) Engine(engine string) ApiGetClusterMetricsRequest {
	r.engine = &engine
	return r
}
...
type ApiGetEksAnywhereClusterJwtRequest struct {
	ctx            context.Context
	ApiService     *ClustersAPIService
	organizationId string
	clusterId      string
...
func (r ApiGetEksAnywhereClusterJwtRequest) Execute() (*EksAnywhereClusterJwtResponse, *http.Response, error) {
	return r.ApiService.GetEksAnywhereClusterJwtExecute(r)
}
...
Returns the latest valid JWT currently used for engine deployments for the specified EKS Anywhere cluster.
	...
	@param organizationId Organization ID
	@param clusterId Cluster ID
	@return ApiGetEksAnywhereClusterJwtRequest
*/
func (a *ClustersAPIService) GetEksAnywhereClusterJwt(ctx context.Context, organizationId string, clusterId string) ApiGetEksAnywhereClusterJwtRequest {
	return ApiGetEksAnywhereClusterJwtRequest{
		ApiService:     a,
		ctx:            ctx,
		organizationId: organizationId,
...
// Execute executes the request
//
//	@return EksAnywhereClusterJwtResponse
func (a *ClustersAPIService) GetEksAnywhereClusterJwtExecute(r ApiGetEksAnywhereClusterJwtRequest) (*EksAnywhereClusterJwtResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *EksAnywhereClusterJwtResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ClustersAPIService.GetEksAnywhereClusterJwt")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/organization/{organizationId}/cluster/{clusterId}/eks-anywhere/jwt"
	localVarPath = strings.Replace(localVarPath, "{"+"organizationId"+"}", url.PathEscape(parameterValueToString(r.organizationId, "organizationId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterId"+"}", url.PathEscape(parameterValueToString(r.clusterId, "clusterId")), -1)
...
type ApiGetEnvironmentsByClusterIdRequest struct {
	ctx        context.Context
	ApiService *ClustersAPIService
	clusterId  string
}

func (r ApiGetEnvironmentsByClusterIdRequest) Execute() (*ClusterEnvironmentResponseList, *http.Response, error) {
	return r.ApiService.GetEnvironmentsByClusterIdExecute(r)
}
...
GetEnvironmentsByClusterId List environments services by cluster id
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param clusterId
	@return ApiGetEnvironmentsByClusterIdRequest
*/
func (a *ClustersAPIService) GetEnvironmentsByClusterId(ctx context.Context, clusterId string) ApiGetEnvironmentsByClusterIdRequest {
	return ApiGetEnvironmentsByClusterIdRequest{
		ApiService: a,
		ctx:        ctx,
		clusterId:  clusterId,
...
// Execute executes the request
//
//	@return ClusterEnvironmentResponseList
func (a *ClustersAPIService) GetEnvironmentsByClusterIdExecute(r ApiGetEnvironmentsByClusterIdRequest) (*ClusterEnvironmentResponseList, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *ClusterEnvironmentResponseList
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ClustersAPIService.GetEnvironmentsByClusterId")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/cluster/{clusterId}/environments"
	localVarPath = strings.Replace(localVarPath, "{"+"clusterId"+"}", url.PathEscape(parameterValueToString(r.clusterId, "clusterId")), -1)
...
type ApiListClusterAnalysesRequest struct {
	ctx        context.Context
	ApiService *ClustersAPIService
	clusterId  string
}

func (r ApiListClusterAnalysesRequest) Execute() (*ClusterAnalysisResponseList, *http.Response, error) {
	return r.ApiService.ListClusterAnalysesExecute(r)
}

/*
ListClusterAnalyses List cluster analyses

Lists previous analysis executions for the cluster.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param clusterId Cluster ID
	@return ApiListClusterAnalysesRequest
*/
func (a *ClustersAPIService) ListClusterAnalyses(ctx context.Context, clusterId string) ApiListClusterAnalysesRequest {
	return ApiListClusterAnalysesRequest{
		ApiService: a,
		ctx:        ctx,
		clusterId:  clusterId,
...
// Execute executes the request
//
//	@return ClusterAnalysisResponseList
func (a *ClustersAPIService) ListClusterAnalysesExecute(r ApiListClusterAnalysesRequest) (*ClusterAnalysisResponseList, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *ClusterAnalysisResponseList
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ClustersAPIService.ListClusterAnalyses")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/clusters/{clusterId}/analysis"
	localVarPath = strings.Replace(localVarPath, "{"+"clusterId"+"}", url.PathEscape(parameterValueToString(r.clusterId, "clusterId")), -1)
...
type ApiListClusterAnalysisLogsRequest struct {
	ctx        context.Context
	ApiService *ClustersAPIService
	clusterId  string
	analysisId string
...
func (r ApiListClusterAnalysisLogsRequest) Execute() (*ClusterAnalysisLogResponseList, *http.Response, error) {
	return r.ApiService.ListClusterAnalysisLogsExecute(r)
}

/*
ListClusterAnalysisLogs List cluster analysis logs
...
Returns the persisted cluster analysis report/log lines in order.
	...
	@param clusterId Cluster ID
	@param analysisId Cluster analysis ID
	@return ApiListClusterAnalysisLogsRequest
*/
func (a *ClustersAPIService) ListClusterAnalysisLogs(ctx context.Context, clusterId string, analysisId string) ApiListClusterAnalysisLogsRequest {
	return ApiListClusterAnalysisLogsRequest{
		ApiService: a,
		ctx:        ctx,
		clusterId:  clusterId,
...
// Execute executes the request
//
//	@return ClusterAnalysisLogResponseList
func (a *ClustersAPIService) ListClusterAnalysisLogsExecute(r ApiListClusterAnalysisLogsRequest) (*ClusterAnalysisLogResponseList, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *ClusterAnalysisLogResponseList
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ClustersAPIService.ListClusterAnalysisLogs")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/clusters/{clusterId}/analysis/{analysisId}/logs"
	localVarPath = strings.Replace(localVarPath, "{"+"clusterId"+"}", url.PathEscape(parameterValueToString(r.clusterId, "clusterId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"analysisId"+"}", url.PathEscape(parameterValueToString(r.analysisId, "analysisId")), -1)
...
type ApiStartClusterAnalysisRequest struct {
	ctx                    context.Context
	ApiService             *ClustersAPIService
	clusterId              string
...
func (r ApiStartClusterAnalysisRequest) ClusterAnalysisRequest(clusterAnalysisRequest ClusterAnalysisRequest) ApiStartClusterAnalysisRequest {
	r.clusterAnalysisRequest = &clusterAnalysisRequest
	return r
}

func (r ApiStartClusterAnalysisRequest) Execute() (*ClusterAnalysisResponse, *http.Response, error) {
	return r.ApiService.StartClusterAnalysisExecute(r)
}

/*
StartClusterAnalysis Start cluster analysis
...
Starts a read-only analysis for the cluster. The result and logs can be retrieved later from the cluster analysis endpoints.
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param clusterId Cluster ID
	@return ApiStartClusterAnalysisRequest
*/
func (a *ClustersAPIService) StartClusterAnalysis(ctx context.Context, clusterId string) ApiStartClusterAnalysisRequest {
	return ApiStartClusterAnalysisRequest{
		ApiService: a,
		ctx:        ctx,
		clusterId:  clusterId,
...
//
//	@return ClusterAnalysisResponse
func (a *ClustersAPIService) StartClusterAnalysisExecute(r ApiStartClusterAnalysisRequest) (*ClusterAnalysisResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ClustersAPIService.StartClusterAnalysis")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.clusterAnalysisRequest == nil {
		return localVarReturnValue, nil, reportError("clusterAnalysisRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.clusterAnalysisRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["ApiKeyAuth"]; ok {
