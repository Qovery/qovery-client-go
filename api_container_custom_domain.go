...
*/
func (a *ContainerCustomDomainAPIService) CheckContainerCustomDomain(ctx context.Context, containerId string) ApiCheckContainerCustomDomainRequest {
	return ApiCheckContainerCustomDomainRequest{
		ApiService:  a,
		ctx:         ctx,
...
func (a *ContainerCustomDomainAPIService) CheckContainerCustomDomainExecute(r ApiCheckContainerCustomDomainRequest) (*CheckedCustomDomainsResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ContainerCustomDomainAPIService.CheckContainerCustomDomain")
	if err != nil {
