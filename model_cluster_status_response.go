...
type ClusterStatusResponse struct {
	...
	Status     *ClusterDeploymentStatusEnum `json:"status,omitempty"`
...
// SetStatus gets a reference to the given ClusterDeploymentStatusEnum and assigns it to the Status field.
