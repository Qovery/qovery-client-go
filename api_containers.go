...
*/
func (a *ContainersAPIService) CloneHelm(ctx context.Context, helmId string) ApiCloneHelmRequest {
	return ApiCloneHelmRequest{
		ApiService: a,
		ctx:        ctx,
		helmId:     helmId,
...
// Execute executes the request
//  @return HelmResponse
func (a *ContainersAPIService) CloneHelmExecute(r ApiCloneHelmRequest) (*HelmResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ContainersAPIService.CloneHelm")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
