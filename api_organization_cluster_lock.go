...
// OrganizationClusterLockAPIService OrganizationClusterLockAPI service
type OrganizationClusterLockAPIService service

type ApiListClusterLockRequest struct {
	ctx            context.Context
	ApiService     *OrganizationClusterLockAPIService
...
func (a *OrganizationClusterLockAPIService) ListClusterLockExecute(r ApiListClusterLockRequest) (*ClusterLockList, *http.Response, error) {
	...
	localVarPath := localBasePath + "/organization/{organizationId}/lock"
