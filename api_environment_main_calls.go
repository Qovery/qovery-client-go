...
type ApiGetEnvironmentDeploymentQueueRequest struct {
	ctx           context.Context
	ApiService    *EnvironmentMainCallsAPIService
	environmentId string
}

func (r ApiGetEnvironmentDeploymentQueueRequest) Execute() (*QueuedDeploymentRequestWithStages, *http.Response, error) {
	return r.ApiService.GetEnvironmentDeploymentQueueExecute(r)
}

/*
GetEnvironmentDeploymentQueue Get Deployment Queue By EnvironmentId

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param environmentId
 @return ApiGetEnvironmentDeploymentQueueRequest
*/
func (a *EnvironmentMainCallsAPIService) GetEnvironmentDeploymentQueue(ctx context.Context, environmentId string) ApiGetEnvironmentDeploymentQueueRequest {
	return ApiGetEnvironmentDeploymentQueueRequest{
		ApiService:    a,
		ctx:           ctx,
		environmentId: environmentId,
...
// Execute executes the request
//  @return QueuedDeploymentRequestWithStages
func (a *EnvironmentMainCallsAPIService) GetEnvironmentDeploymentQueueExecute(r ApiGetEnvironmentDeploymentQueueRequest) (*QueuedDeploymentRequestWithStages, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *QueuedDeploymentRequestWithStages
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EnvironmentMainCallsAPIService.GetEnvironmentDeploymentQueue")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
