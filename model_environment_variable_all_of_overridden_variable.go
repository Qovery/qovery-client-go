...
func NewEnvironmentVariableAllOfOverriddenVariable() *EnvironmentVariableAllOfOverriddenVariable {
	this := EnvironmentVariableAllOfOverriddenVariable{}
	return &this
}
...
func (o EnvironmentVariableAllOfOverriddenVariable) MarshalJSON() ([]byte, error) {
...
type NullableEnvironmentVariableAllOfOverriddenVariable struct {
	value *EnvironmentVariableAllOfOverriddenVariable
	isSet bool
}

func (v NullableEnvironmentVariableAllOfOverriddenVariable) Get() *EnvironmentVariableAllOfOverriddenVariable {
	return v.value
}

func (v *NullableEnvironmentVariableAllOfOverriddenVariable) Set(val *EnvironmentVariableAllOfOverriddenVariable) {
	v.value = val
	v.isSet = true
}

func (v NullableEnvironmentVariableAllOfOverriddenVariable) IsSet() bool {
	return v.isSet
}

func (v *NullableEnvironmentVariableAllOfOverriddenVariable) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEnvironmentVariableAllOfOverriddenVariable(val *EnvironmentVariableAllOfOverriddenVariable) *NullableEnvironmentVariableAllOfOverriddenVariable {
	return &NullableEnvironmentVariableAllOfOverriddenVariable{value: val, isSet: true}
}

func (v NullableEnvironmentVariableAllOfOverriddenVariable) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEnvironmentVariableAllOfOverriddenVariable) UnmarshalJSON(src []byte) error {
	v.isSet = true
