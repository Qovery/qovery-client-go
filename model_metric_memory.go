...
// checks if the MetricMemory type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MetricMemory{}
...
func (o MetricMemory) ToMap() (map[string]interface{}, error) {
