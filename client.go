...
// APIClient manages communication with the Qovery API API v1.0.4
...
type APIClient struct {
	...
	BlueprintCatalogAPI *BlueprintCatalogAPIService
	...
	EnvironmentActionsAPI *EnvironmentActionsAPIService

	EnvironmentDeploymentHistoryAPI *EnvironmentDeploymentHistoryAPIService
	...
	EnvironmentSecretAPI *EnvironmentSecretAPIService
	...
	HelmActionsAPI *HelmActionsAPIService
	...
	HelmMainCallsAPI *HelmMainCallsAPIService

	HelmRepositoriesAPI *HelmRepositoriesAPIService
	...
	OrganizationEnterpriseConnectionAPI *OrganizationEnterpriseConnectionAPIService
	...
	ProjectMainCallsAPI *ProjectMainCallsAPIService
	...
	SecretManagerAccessAPI *SecretManagerAccessAPIService

	ServiceMainCallsAPI *ServiceMainCallsAPIService

	ServiceStatusAPI *ServiceStatusAPIService

	TerraformActionsAPI *TerraformActionsAPIService

	TerraformConfigurationAPI *TerraformConfigurationAPIService
	...
	TerraformResourcesAPI *TerraformResourcesAPIService

	TerraformsAPI *TerraformsAPIService

	UserSignUpAPI *UserSignUpAPIService

	VariableMainCallsAPI *VariableMainCallsAPIService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.OrganizationEnterpriseConnectionAPI = (*OrganizationEnterpriseConnectionAPIService)(&c.common)
	...
	c.SecretManagerAccessAPI = (*SecretManagerAccessAPIService)(&c.common)
	c.ServiceMainCallsAPI = (*ServiceMainCallsAPIService)(&c.common)
	c.ServiceStatusAPI = (*ServiceStatusAPIService)(&c.common)
	c.TerraformActionsAPI = (*TerraformActionsAPIService)(&c.common)
	...
	c.TerraformResourcesAPI = (*TerraformResourcesAPIService)(&c.common)
	c.TerraformsAPI = (*TerraformsAPIService)(&c.common)
	c.UserSignUpAPI = (*UserSignUpAPIService)(&c.common)
	c.VariableMainCallsAPI = (*VariableMainCallsAPIService)(&c.common)
