...
func (r ApiGetEnvironmentLifecycleTemplateRequest) Execute() (*LifecycleTemplateResponse, *http.Response, error) {
	return r.ApiService.GetEnvironmentLifecycleTemplateExecute(r)
}
...
func (a *LifecycleTemplateMainCallsAPIService) GetEnvironmentLifecycleTemplateExecute(r ApiGetEnvironmentLifecycleTemplateRequest) (*LifecycleTemplateResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/environment/{environmentId}/lifecycleTemplate/{lifecycleTemplateId}"
	localVarPath = strings.Replace(localVarPath, "{"+"environmentId"+"}", url.PathEscape(parameterValueToString(r.environmentId, "environmentId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"lifecycleTemplateId"+"}", url.PathEscape(parameterValueToString(r.lifecycleTemplateId, "lifecycleTemplateId")), -1)
...
func (a *LifecycleTemplateMainCallsAPIService) ListEnvironmentLifecycleTemplatesExecute(r ApiListEnvironmentLifecycleTemplatesRequest) (*LifecycleTemplateListResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/environment/{environmentId}/lifecycleTemplate"
	localVarPath = strings.Replace(localVarPath, "{"+"environmentId"+"}", url.PathEscape(parameterValueToString(r.environmentId, "environmentId")), -1)
