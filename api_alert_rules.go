...
type ApiGetAlertRulesRequest struct {
	ctx            context.Context
	ApiService     *AlertRulesAPIService
	organizationId string
}

func (r ApiGetAlertRulesRequest) Execute() (*AlertRuleList, *http.Response, error) {
	return r.ApiService.GetAlertRulesExecute(r)
}
...
Retrieve all alert rules for a specific organization
	...
	@return ApiGetAlertRulesRequest
*/
func (a *AlertRulesAPIService) GetAlertRules(ctx context.Context, organizationId string) ApiGetAlertRulesRequest {
	return ApiGetAlertRulesRequest{
		ApiService:     a,
		ctx:            ctx,
...
func (a *AlertRulesAPIService) GetAlertRulesExecute(r ApiGetAlertRulesRequest) (*AlertRuleList, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AlertRulesAPIService.GetAlertRules")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/organization/{organizationId}/alert-rules"
