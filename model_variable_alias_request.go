...
type VariableAliasRequest struct {
	Key           string               `json:"key"`
	AliasScope    APIVariableScopeEnum `json:"aliasScope"`
	AliasParentId string               `json:"aliasParentId"`
}
...
func (o VariableAliasRequest) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["aliasScope"] = o.AliasScope
	}
	if true {
		toSerialize["aliasParentId"] = o.AliasParentId
	}
