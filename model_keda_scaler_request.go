...
type KedaScalerRequest struct {
	...
	TriggerAuthentication *KedaTriggerAuthenticationRequest `json:"trigger_authentication,omitempty"`
...
func (o *KedaScalerRequest) GetTriggerAuthentication() KedaTriggerAuthenticationRequest {
	if o == nil || IsNil(o.TriggerAuthentication) {
		var ret KedaTriggerAuthenticationRequest
		return ret
	}
...
// SetTriggerAuthentication gets a reference to the given KedaTriggerAuthenticationRequest and assigns it to the TriggerAuthentication field.
