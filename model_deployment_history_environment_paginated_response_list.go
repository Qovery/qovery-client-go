...
var _ MappedNullable = &DeploymentHistoryEnvironmentPaginatedResponseList{}
...
func (o DeploymentHistoryEnvironmentPaginatedResponseList) ToMap() (map[string]interface{}, error) {
