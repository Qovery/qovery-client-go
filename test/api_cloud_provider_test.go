...
func Test_qovery_CloudProviderAPIService(t *testing.T) {
	...
	t.Run("Test CloudProviderAPIService ListAzureFeatures", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.CloudProviderAPI.ListAzureFeatures(context.Background()).Execute()
	...
	t.Run("Test CloudProviderAPIService ListAzureRegions", func(t *testing.T) {

		t.Skip("skip test") // remove to run test

		resp, httpRes, err := apiClient.CloudProviderAPI.ListAzureRegions(context.Background()).Execute()
