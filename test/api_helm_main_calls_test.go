...
func Test_qovery_HelmMainCallsAPIService(t *testing.T) {
	...
	t.Run("Test HelmMainCallsAPIService GetHelmKubernetesServices", func(t *testing.T) {

		t.Skip("skip test") // remove to run test

		var helmId string

		resp, httpRes, err := apiClient.HelmMainCallsAPI.GetHelmKubernetesServices(context.Background(), helmId).Execute()
	...
	t.Run("Test HelmMainCallsAPIService ListHelmCommit", func(t *testing.T) {

		t.Skip("skip test") // remove to run test

		var helmId string

		resp, httpRes, err := apiClient.HelmMainCallsAPI.ListHelmCommit(context.Background(), helmId).Execute()
	...
	t.Run("Test HelmMainCallsAPIService ListHelmLinks", func(t *testing.T) {

		t.Skip("skip test") // remove to run test

		var helmId string

		resp, httpRes, err := apiClient.HelmMainCallsAPI.ListHelmLinks(context.Background(), helmId).Execute()
