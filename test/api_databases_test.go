...
func Test_qovery_DatabasesAPIService(t *testing.T) {
	...
	t.Run("Test DatabasesAPIService ListEnvironmentDatabaseCurrentMetric", func(t *testing.T) {

		t.Skip("skip test") // remove to run test

		var environmentId string

		resp, httpRes, err := apiClient.DatabasesAPI.ListEnvironmentDatabaseCurrentMetric(context.Background(), environmentId).Execute()
