...
func Test_qovery_AlertRulesAPIService(t *testing.T) {
	...
	t.Run("Test AlertRulesAPIService GetAlertRules", func(t *testing.T) {

		t.Skip("skip test") // remove to run test

		var organizationId string

		resp, httpRes, err := apiClient.AlertRulesAPI.GetAlertRules(context.Background(), organizationId).Execute()
