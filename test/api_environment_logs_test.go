...
Testing EnvironmentLogsAPIService
...
func Test_qovery_EnvironmentLogsAPIService(t *testing.T) {
	...
	t.Run("Test EnvironmentLogsAPIService ListEnvironmentLogs", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.EnvironmentLogsAPI.ListEnvironmentLogs(context.Background(), environmentId).Execute()
