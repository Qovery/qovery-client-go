...
func Test_qovery_OrganizationMainCallsAPIService(t *testing.T) {
	...
	t.Run("Test OrganizationMainCallsAPIService ListTfVarsFilesFromGitRepo", func(t *testing.T) {

		t.Skip("skip test") // remove to run test

		var organizationId string

		resp, httpRes, err := apiClient.OrganizationMainCallsAPI.ListTfVarsFilesFromGitRepo(context.Background(), organizationId).Execute()
