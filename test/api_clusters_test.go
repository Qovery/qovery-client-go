...
func Test_qovery_ClustersAPIService(t *testing.T) {
	...
	t.Run("Test ClustersAPIService CreateSelfManagedCluster", func(t *testing.T) {

		t.Skip("skip test") // remove to run test

		var organizationId string

		resp, httpRes, err := apiClient.ClustersAPI.CreateSelfManagedCluster(context.Background(), organizationId).Execute()
	...
	t.Run("Test ClustersAPIService GetClusterMetrics", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.ClustersAPI.GetClusterMetrics(context.Background(), clusterId).Execute()
	...
	t.Run("Test ClustersAPIService GetEksAnywhereClusterJwt", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.ClustersAPI.GetEksAnywhereClusterJwt(context.Background(), organizationId, clusterId).Execute()
	...
	t.Run("Test ClustersAPIService GetEnvironmentsByClusterId", func(t *testing.T) {

		t.Skip("skip test") // remove to run test

		var clusterId string

		resp, httpRes, err := apiClient.ClustersAPI.GetEnvironmentsByClusterId(context.Background(), clusterId).Execute()
	...
	t.Run("Test ClustersAPIService ListEksAnywhereCommits", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.ClustersAPI.ListEksAnywhereCommits(context.Background(), organizationId, clusterId).Execute()
	...
	t.Run("Test ClustersAPIService UpdateEksAnywhereCommit", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.ClustersAPI.UpdateEksAnywhereCommit(context.Background(), organizationId, clusterId).Execute()
