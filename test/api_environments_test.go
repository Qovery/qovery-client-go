...
func Test_qovery_EnvironmentsAPIService(t *testing.T) {
	...
	t.Run("Test EnvironmentsAPIService GetProjectEnvironmentsOverviewDeprecated", func(t *testing.T) {

		t.Skip("skip test") // remove to run test

		var projectId string

		resp, httpRes, err := apiClient.EnvironmentsAPI.GetProjectEnvironmentsOverviewDeprecated(context.Background(), projectId).Execute()
