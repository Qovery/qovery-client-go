...
func Test_qovery_DefaultAPIService(t *testing.T) {
	...
	t.Run("Test DefaultAPIService GetHelmKubernetesServices", func(t *testing.T) {

		t.Skip("skip test") // remove to run test

		var helmId string

		resp, httpRes, err := apiClient.DefaultAPI.GetHelmKubernetesServices(context.Background(), helmId).Execute()
