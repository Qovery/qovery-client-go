...
type ApiUninstallContainerRequest struct {
	ctx         context.Context
	ApiService  *ContainerActionsAPIService
	containerId string
...
func (r ApiUninstallContainerRequest) Body(body map[string]interface{}) ApiUninstallContainerRequest {
	r.body = &body
	return r
}
...
Delete the resources of the container but keep Qovery configuration
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param containerId Container ID
	@return ApiUninstallContainerRequest
*/
func (a *ContainerActionsAPIService) UninstallContainer(ctx context.Context, containerId string) ApiUninstallContainerRequest {
	return ApiUninstallContainerRequest{
		ApiService:  a,
		ctx:         ctx,
		containerId: containerId,
...
func (a *ContainerActionsAPIService) UninstallContainerExecute(r ApiUninstallContainerRequest) (*Status, *http.Response, error) {
	...
	localVarPath := localBasePath + "/container/{containerId}/uninstall"
	localVarPath = strings.Replace(localVarPath, "{"+"containerId"+"}", url.PathEscape(parameterValueToString(r.containerId, "containerId")), -1)
