...
func (o EnvironmentDeploymentRuleResponseAllOf) MarshalJSON() ([]byte, error) {
...
type NullableEnvironmentDeploymentRuleResponseAllOf struct {
	value *EnvironmentDeploymentRuleResponseAllOf
	isSet bool
}

func (v NullableEnvironmentDeploymentRuleResponseAllOf) Get() *EnvironmentDeploymentRuleResponseAllOf {
	return v.value
}

func (v *NullableEnvironmentDeploymentRuleResponseAllOf) Set(val *EnvironmentDeploymentRuleResponseAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableEnvironmentDeploymentRuleResponseAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableEnvironmentDeploymentRuleResponseAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEnvironmentDeploymentRuleResponseAllOf(val *EnvironmentDeploymentRuleResponseAllOf) *NullableEnvironmentDeploymentRuleResponseAllOf {
	return &NullableEnvironmentDeploymentRuleResponseAllOf{value: val, isSet: true}
}

func (v NullableEnvironmentDeploymentRuleResponseAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEnvironmentDeploymentRuleResponseAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
