...
`func (o *ApplicationRequestAllOf) GetBuildMode() string`

GetBuildMode returns the BuildMode field if non-nil, zero value otherwise.

### GetBuildModeOk

`func (o *ApplicationRequestAllOf) GetBuildModeOk() (*string, bool)`
...
`func (o *ApplicationRequestAllOf) SetBuildMode(v string)`
