...
`func NewApplicationRequestAllOf(name string, gitRepository ApplicationGitRepositoryRequest, healthchecks Healthcheck, ) *ApplicationRequestAllOf`
...
`func (o *ApplicationRequestAllOf) GetHealthchecksOk() (*Healthcheck, bool)`
