...
`func NewLifecycleJobResponse(id string, createdAt time.Time, environment ReferenceObject, maximumCpu int32, maximumMemory int32, maximumGpu int32, name string, cpu int32, memory int32, gpu int32, autoPreview bool, source BaseJobResponseAllOfSource, healthchecks Healthcheck, iconUri string, serviceType ServiceTypeEnum, jobType JobTypeEnum, schedule LifecycleJobResponseAllOfSchedule, ) *LifecycleJobResponse`
...
`func (o *LifecycleJobResponse) GetEphemeralStorageInGib() int32`
...
`func (o *LifecycleJobResponse) GetEphemeralStorageInGibOk() (*int32, bool)`
...
`func (o *LifecycleJobResponse) SetCpuArchitecture(v CpuArchitectureEnum)`

SetCpuArchitecture sets CpuArchitecture field to given value.

### HasCpuArchitecture

`func (o *LifecycleJobResponse) HasCpuArchitecture() bool`

HasCpuArchitecture returns a boolean if a field has been set.

### SetCpuArchitectureNil

`func (o *LifecycleJobResponse) SetCpuArchitectureNil(b bool)`

 SetCpuArchitectureNil sets the value for CpuArchitecture to be an explicit nil

### UnsetCpuArchitecture
`func (o *LifecycleJobResponse) UnsetCpuArchitecture()`
