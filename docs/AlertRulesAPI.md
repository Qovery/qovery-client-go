...
func main() {
	alertRuleCreationRequest := *openapiclient.NewAlertRuleCreationRequest("OrganizationId_example", "ClusterId_example", "Name_example", "Description_example", "Tag_example", *openapiclient.NewAlertRuleCondition(openapiclient.AlertRuleConditionKind("CUSTOM"), "Promql_example"), "ForDuration_example", openapiclient.AlertSeverity("LOW"), *openapiclient.NewAlertPresentation(), false, []string{"AlertReceiverIds_example"}, "TODO") // AlertRuleCreationRequest |  (optional)
...
func main() {
	alertRuleId := "38400000-8cf0-11bd-b23e-10b96e4ef00d" // string | Alert Rule ID
	alertRuleEditRequest := *openapiclient.NewAlertRuleEditRequest("Name_example", "Description_example", "Tag_example", *openapiclient.NewAlertRuleCondition(openapiclient.AlertRuleConditionKind("CUSTOM"), "Promql_example"), "ForDuration_example", openapiclient.AlertSeverity("LOW"), false, []string{"AlertReceiverIds_example"}, *openapiclient.NewAlertPresentation()) // AlertRuleEditRequest |  (optional)
