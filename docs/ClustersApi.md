...
func main() {
    ...
    clusterRequest := *openapiclient.NewClusterRequest("Name_example", openapiclient.CloudProviderEnum("AWS"), "Region_example", openapiclient.KubernetesEnum("K3S")) // ClusterRequest |  (optional)
