...
`func (o *JobRequest) GetEphemeralStorageInGib() int32`
...
`func (o *JobRequest) GetEphemeralStorageInGibOk() (*int32, bool)`
...
`func (o *JobRequest) SetEphemeralStorageInGib(v int32)`

SetEphemeralStorageInGib sets EphemeralStorageInGib field to given value.

### HasEphemeralStorageInGib

`func (o *JobRequest) HasEphemeralStorageInGib() bool`
