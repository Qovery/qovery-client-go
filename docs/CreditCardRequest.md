...
**ExpiryMonth** | **int32** |  | 
**ExpiryYear** | **int32** |  | 
**Token** | **NullableString** | Token generated by payment solution platform. | 

## Methods

### NewCreditCardRequest

`func NewCreditCardRequest(number string, cvv string, expiryMonth int32, expiryYear int32, token NullableString, ) *CreditCardRequest`
