...
> []OrganizationAnnotationsGroupResponse ListDatabaseAnnotationsGroup(ctx, databaseId).Execute()
...
func main() {
    ...
    // response from `ListDatabaseAnnotationsGroup`: []OrganizationAnnotationsGroupResponse
