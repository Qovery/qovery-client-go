...
func main() {
	...
	awsCredentialsRequest := openapiclient.AwsCredentialsRequest{AwsRoleCredentialsRequest: openapiclient.NewAwsRoleCredentialsRequest("Type_example", "Name_example", "RoleArn_example")} // AwsCredentialsRequest |  (optional)
...
func main() {
	organizationId := "38400000-8cf0-11bd-b23e-10b96e4ef00d" // string | Organization ID
	azureCredentialsRequest := *openapiclient.NewAzureCredentialsRequest("Name_example", "AzureSubscriptionId_example", "AzureTenantId_example") // AzureCredentialsRequest |  (optional)
