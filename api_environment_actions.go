...
type ApiCleanFailedJobsRequest struct {
	ctx                    context.Context
	ApiService             *EnvironmentActionsAPIService
	environmentId          string
...
func (r ApiCleanFailedJobsRequest) CleanFailedJobsRequest(cleanFailedJobsRequest CleanFailedJobsRequest) ApiCleanFailedJobsRequest {
	r.cleanFailedJobsRequest = &cleanFailedJobsRequest
	return r
}

func (r ApiCleanFailedJobsRequest) Execute() (*CleanFailedJobs200Response, *http.Response, error) {
	return r.ApiService.CleanFailedJobsExecute(r)
}
...
CleanFailedJobs Clean failed jobs within an environment
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param environmentId
	@return ApiCleanFailedJobsRequest
*/
func (a *EnvironmentActionsAPIService) CleanFailedJobs(ctx context.Context, environmentId string) ApiCleanFailedJobsRequest {
	return ApiCleanFailedJobsRequest{
		ApiService:    a,
		ctx:           ctx,
		environmentId: environmentId,
...
// Execute executes the request
//
//	@return CleanFailedJobs200Response
func (a *EnvironmentActionsAPIService) CleanFailedJobsExecute(r ApiCleanFailedJobsRequest) (*CleanFailedJobs200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *CleanFailedJobs200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EnvironmentActionsAPIService.CleanFailedJobs")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/environment/{environmentId}/cleanFailedJobs"
	localVarPath = strings.Replace(localVarPath, "{"+"environmentId"+"}", url.PathEscape(parameterValueToString(r.environmentId, "environmentId")), -1)
	...
	// body params
	localVarPostBody = r.cleanFailedJobsRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["ApiKeyAuth"]; ok {
...
type ApiUninstallEnvironmentRequest struct {
	ctx           context.Context
	ApiService    *EnvironmentActionsAPIService
	environmentId string
}

func (r ApiUninstallEnvironmentRequest) Execute() (map[string]interface{}, *http.Response, error) {
	return r.ApiService.UninstallEnvironmentExecute(r)
}
...
This will uninstall all the services of this environment.
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param environmentId Environment ID
	@return ApiUninstallEnvironmentRequest
*/
func (a *EnvironmentActionsAPIService) UninstallEnvironment(ctx context.Context, environmentId string) ApiUninstallEnvironmentRequest {
	return ApiUninstallEnvironmentRequest{
		ApiService:    a,
		ctx:           ctx,
		environmentId: environmentId,
...
func (a *EnvironmentActionsAPIService) UninstallEnvironmentExecute(r ApiUninstallEnvironmentRequest) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EnvironmentActionsAPIService.UninstallEnvironment")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/environment/{environmentId}/uninstall"
	localVarPath = strings.Replace(localVarPath, "{"+"environmentId"+"}", url.PathEscape(parameterValueToString(r.environmentId, "environmentId")), -1)
...
type ApiUninstallSelectedServicesRequest struct {
	ctx                             context.Context
	ApiService                      *EnvironmentActionsAPIService
	environmentId                   string
	environmentServiceIdsAllRequest *EnvironmentServiceIdsAllRequest
...
func (r ApiUninstallSelectedServicesRequest) EnvironmentServiceIdsAllRequest(environmentServiceIdsAllRequest EnvironmentServiceIdsAllRequest) ApiUninstallSelectedServicesRequest {
	r.environmentServiceIdsAllRequest = &environmentServiceIdsAllRequest
	return r
}

func (r ApiUninstallSelectedServicesRequest) Execute() (*http.Response, error) {
	return r.ApiService.UninstallSelectedServicesExecute(r)
}
...
uninstall selected services
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param environmentId Environment ID
	@return ApiUninstallSelectedServicesRequest
*/
func (a *EnvironmentActionsAPIService) UninstallSelectedServices(ctx context.Context, environmentId string) ApiUninstallSelectedServicesRequest {
	return ApiUninstallSelectedServicesRequest{
		ApiService:    a,
		ctx:           ctx,
		environmentId: environmentId,
...
// Execute executes the request
func (a *EnvironmentActionsAPIService) UninstallSelectedServicesExecute(r ApiUninstallSelectedServicesRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodPost
		localVarPostBody   interface{}
		formFiles          []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EnvironmentActionsAPIService.UninstallSelectedServices")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/environment/{environmentId}/service/uninstall"
	localVarPath = strings.Replace(localVarPath, "{"+"environmentId"+"}", url.PathEscape(parameterValueToString(r.environmentId, "environmentId")), -1)
