...
type ApiGetOrganizationOnboardingRequest struct {
	ctx            context.Context
	ApiService     *OrganizationMainCallsAPIService
	organizationId string
}

func (r ApiGetOrganizationOnboardingRequest) Execute() (*OrganizationOnboardingResponse, *http.Response, error) {
	return r.ApiService.GetOrganizationOnboardingExecute(r)
}

/*
GetOrganizationOnboarding Get the onboarding status of an organization

Returns the onboarding status for the given organization and the use cases selected by the owner at sign-up.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param organizationId Organization ID
	@return ApiGetOrganizationOnboardingRequest
*/
func (a *OrganizationMainCallsAPIService) GetOrganizationOnboarding(ctx context.Context, organizationId string) ApiGetOrganizationOnboardingRequest {
	return ApiGetOrganizationOnboardingRequest{
		ApiService:     a,
		ctx:            ctx,
		organizationId: organizationId,
...
func (a *OrganizationMainCallsAPIService) GetOrganizationOnboardingExecute(r ApiGetOrganizationOnboardingRequest) (*OrganizationOnboardingResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *OrganizationOnboardingResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OrganizationMainCallsAPIService.GetOrganizationOnboarding")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/organization/{organizationId}/onboarding"
	localVarPath = strings.Replace(localVarPath, "{"+"organizationId"+"}", url.PathEscape(parameterValueToString(r.organizationId, "organizationId")), -1)
...
type ApiListEnvironmentsByOrganizationIdRequest struct {
	ctx            context.Context
	ApiService     *OrganizationMainCallsAPIService
	organizationId string
}

func (r ApiListEnvironmentsByOrganizationIdRequest) Execute() (*ListEnvironmentsByOrganizationId200Response, *http.Response, error) {
	return r.ApiService.ListEnvironmentsByOrganizationIdExecute(r)
}
...
ListEnvironmentsByOrganizationId List Environments By OrganizationId
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param organizationId
	@return ApiListEnvironmentsByOrganizationIdRequest
*/
func (a *OrganizationMainCallsAPIService) ListEnvironmentsByOrganizationId(ctx context.Context, organizationId string) ApiListEnvironmentsByOrganizationIdRequest {
	return ApiListEnvironmentsByOrganizationIdRequest{
		ApiService:     a,
		ctx:            ctx,
		organizationId: organizationId,
...
// Execute executes the request
//
//	@return ListEnvironmentsByOrganizationId200Response
func (a *OrganizationMainCallsAPIService) ListEnvironmentsByOrganizationIdExecute(r ApiListEnvironmentsByOrganizationIdRequest) (*ListEnvironmentsByOrganizationId200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *ListEnvironmentsByOrganizationId200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OrganizationMainCallsAPIService.ListEnvironmentsByOrganizationId")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/organization/{organizationId}/environments"
	localVarPath = strings.Replace(localVarPath, "{"+"organizationId"+"}", url.PathEscape(parameterValueToString(r.organizationId, "organizationId")), -1)
...
type ApiListTfVarsFilesFromGitRepoRequest struct {
	ctx               context.Context
	ApiService        *OrganizationMainCallsAPIService
	organizationId    string
	tfVarsListRequest *TfVarsListRequest
}

func (r ApiListTfVarsFilesFromGitRepoRequest) TfVarsListRequest(tfVarsListRequest TfVarsListRequest) ApiListTfVarsFilesFromGitRepoRequest {
	r.tfVarsListRequest = &tfVarsListRequest
	return r
}

func (r ApiListTfVarsFilesFromGitRepoRequest) Execute() (*ListTfVarsFilesFromGitRepo200Response, *http.Response, error) {
	return r.ApiService.ListTfVarsFilesFromGitRepoExecute(r)
}
...
ListTfVarsFilesFromGitRepo List Terraform tfvars files from Git repository
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param organizationId Organization ID
	@return ApiListTfVarsFilesFromGitRepoRequest
*/
func (a *OrganizationMainCallsAPIService) ListTfVarsFilesFromGitRepo(ctx context.Context, organizationId string) ApiListTfVarsFilesFromGitRepoRequest {
	return ApiListTfVarsFilesFromGitRepoRequest{
		ApiService:     a,
		ctx:            ctx,
		organizationId: organizationId,
...
// Execute executes the request
//
//	@return ListTfVarsFilesFromGitRepo200Response
func (a *OrganizationMainCallsAPIService) ListTfVarsFilesFromGitRepoExecute(r ApiListTfVarsFilesFromGitRepoRequest) (*ListTfVarsFilesFromGitRepo200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *ListTfVarsFilesFromGitRepo200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OrganizationMainCallsAPIService.ListTfVarsFilesFromGitRepo")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/organization/{organizationId}/listTfVarsFilesFromGitRepo"
	localVarPath = strings.Replace(localVarPath, "{"+"organizationId"+"}", url.PathEscape(parameterValueToString(r.organizationId, "organizationId")), -1)

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.tfVarsListRequest == nil {
		return localVarReturnValue, nil, reportError("tfVarsListRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.tfVarsListRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["ApiKeyAuth"]; ok {
...
type ApiParseTerraformVariablesFromGitRepoRequest struct {
	ctx                             context.Context
	ApiService                      *OrganizationMainCallsAPIService
	organizationId                  string
	terraformVariableParsingRequest *TerraformVariableParsingRequest
}

func (r ApiParseTerraformVariablesFromGitRepoRequest) TerraformVariableParsingRequest(terraformVariableParsingRequest TerraformVariableParsingRequest) ApiParseTerraformVariablesFromGitRepoRequest {
	r.terraformVariableParsingRequest = &terraformVariableParsingRequest
	return r
}

func (r ApiParseTerraformVariablesFromGitRepoRequest) Execute() (*ParseTerraformVariablesFromGitRepo200Response, *http.Response, error) {
	return r.ApiService.ParseTerraformVariablesFromGitRepoExecute(r)
}
...
ParseTerraformVariablesFromGitRepo Parse Terraform variables from Git repository
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param organizationId Organization ID
	@return ApiParseTerraformVariablesFromGitRepoRequest
*/
func (a *OrganizationMainCallsAPIService) ParseTerraformVariablesFromGitRepo(ctx context.Context, organizationId string) ApiParseTerraformVariablesFromGitRepoRequest {
	return ApiParseTerraformVariablesFromGitRepoRequest{
		ApiService:     a,
		ctx:            ctx,
		organizationId: organizationId,
...
// Execute executes the request
//
//	@return ParseTerraformVariablesFromGitRepo200Response
func (a *OrganizationMainCallsAPIService) ParseTerraformVariablesFromGitRepoExecute(r ApiParseTerraformVariablesFromGitRepoRequest) (*ParseTerraformVariablesFromGitRepo200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *ParseTerraformVariablesFromGitRepo200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OrganizationMainCallsAPIService.ParseTerraformVariablesFromGitRepo")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/organization/{organizationId}/parseTerraformVariablesFromGitRepo"
	localVarPath = strings.Replace(localVarPath, "{"+"organizationId"+"}", url.PathEscape(parameterValueToString(r.organizationId, "organizationId")), -1)

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.terraformVariableParsingRequest == nil {
		return localVarReturnValue, nil, reportError("terraformVariableParsingRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.terraformVariableParsingRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["ApiKeyAuth"]; ok {
...
type ApiUpdateOrganizationOnboardingRequest struct {
	ctx                                context.Context
	ApiService                         *OrganizationMainCallsAPIService
	organizationId                     string
	organizationOnboardingPatchRequest *OrganizationOnboardingPatchRequest
}

func (r ApiUpdateOrganizationOnboardingRequest) OrganizationOnboardingPatchRequest(organizationOnboardingPatchRequest OrganizationOnboardingPatchRequest) ApiUpdateOrganizationOnboardingRequest {
	r.organizationOnboardingPatchRequest = &organizationOnboardingPatchRequest
	return r
}

func (r ApiUpdateOrganizationOnboardingRequest) Execute() (*OrganizationOnboardingResponse, *http.Response, error) {
	return r.ApiService.UpdateOrganizationOnboardingExecute(r)
}

/*
UpdateOrganizationOnboarding Update the onboarding status of an organization
...
Updates the onboarding status for the calling user's organization. Only the authenticated user's own sign-up record is updated.
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param organizationId Organization ID
	@return ApiUpdateOrganizationOnboardingRequest
*/
func (a *OrganizationMainCallsAPIService) UpdateOrganizationOnboarding(ctx context.Context, organizationId string) ApiUpdateOrganizationOnboardingRequest {
	return ApiUpdateOrganizationOnboardingRequest{
		ApiService:     a,
		ctx:            ctx,
		organizationId: organizationId,
...
//
//	@return OrganizationOnboardingResponse
func (a *OrganizationMainCallsAPIService) UpdateOrganizationOnboardingExecute(r ApiUpdateOrganizationOnboardingRequest) (*OrganizationOnboardingResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OrganizationMainCallsAPIService.UpdateOrganizationOnboarding")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.organizationOnboardingPatchRequest == nil {
		return localVarReturnValue, nil, reportError("organizationOnboardingPatchRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.organizationOnboardingPatchRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["ApiKeyAuth"]; ok {
