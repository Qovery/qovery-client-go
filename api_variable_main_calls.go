...
type ApiImportEnvironmentVariablesRequest struct {
	ctx                   context.Context
	ApiService            *VariableMainCallsAPIService
	serviceId             *string
...
// service id
func (r ApiImportEnvironmentVariablesRequest) ServiceId(serviceId string) ApiImportEnvironmentVariablesRequest {
...
func (r ApiImportEnvironmentVariablesRequest) VariableImportRequest(variableImportRequest VariableImportRequest) ApiImportEnvironmentVariablesRequest {
	r.variableImportRequest = &variableImportRequest
	return r
}

func (r ApiImportEnvironmentVariablesRequest) Execute() (*VariableImport, *http.Response, error) {
	return r.ApiService.ImportEnvironmentVariablesExecute(r)
}
...
func (a *VariableMainCallsAPIService) ImportEnvironmentVariablesExecute(r ApiImportEnvironmentVariablesRequest) (*VariableImport, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "VariableMainCallsAPIService.ImportEnvironmentVariables")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/variable/import"
