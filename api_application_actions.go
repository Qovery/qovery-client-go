...
type ApiUninstallApplicationRequest struct {
	ctx           context.Context
	ApiService    *ApplicationActionsAPIService
	applicationId string
...
func (r ApiUninstallApplicationRequest) Body(body map[string]interface{}) ApiUninstallApplicationRequest {
	r.body = &body
	return r
}
...
Delete the resources of an application but keep the Qovery config.
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param applicationId Application ID
	@return ApiUninstallApplicationRequest
*/
func (a *ApplicationActionsAPIService) UninstallApplication(ctx context.Context, applicationId string) ApiUninstallApplicationRequest {
	return ApiUninstallApplicationRequest{
		ApiService:    a,
		ctx:           ctx,
		applicationId: applicationId,
...
func (a *ApplicationActionsAPIService) UninstallApplicationExecute(r ApiUninstallApplicationRequest) (map[string]interface{}, *http.Response, error) {
	...
	localVarPath := localBasePath + "/application/{applicationId}/uninstall"
	localVarPath = strings.Replace(localVarPath, "{"+"applicationId"+"}", url.PathEscape(parameterValueToString(r.applicationId, "applicationId")), -1)
