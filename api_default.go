...
*/
func (a *DefaultAPIService) GetHelmRepositoryAssociatedServices(ctx context.Context, organizationId string, helmRepositoryId string) ApiGetHelmRepositoryAssociatedServicesRequest {
	return ApiGetHelmRepositoryAssociatedServicesRequest{
		ApiService:       a,
		ctx:              ctx,
		organizationId:   organizationId,
...
func (a *DefaultAPIService) GetHelmRepositoryAssociatedServicesExecute(r ApiGetHelmRepositoryAssociatedServicesRequest) (*HelmRepositoryAssociatedServicesResponseList, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultAPIService.GetHelmRepositoryAssociatedServices")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
