...
type ApiGetOrganizationOrganizationIdCredentialsRequest struct {
	ctx            context.Context
	ApiService     *DefaultAPIService
	organizationId string
}

func (r ApiGetOrganizationOrganizationIdCredentialsRequest) Execute() (*GetOrganizationOrganizationIdCredentials200Response, *http.Response, error) {
	return r.ApiService.GetOrganizationOrganizationIdCredentialsExecute(r)
}

/*
GetOrganizationOrganizationIdCredentials List credentials of an organization and their associated clusters

List credentials of an organization and their associated clusters

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param organizationId
	@return ApiGetOrganizationOrganizationIdCredentialsRequest
*/
func (a *DefaultAPIService) GetOrganizationOrganizationIdCredentials(ctx context.Context, organizationId string) ApiGetOrganizationOrganizationIdCredentialsRequest {
	return ApiGetOrganizationOrganizationIdCredentialsRequest{
		ApiService:     a,
		ctx:            ctx,
...
// Execute executes the request
//
//	@return GetOrganizationOrganizationIdCredentials200Response
func (a *DefaultAPIService) GetOrganizationOrganizationIdCredentialsExecute(r ApiGetOrganizationOrganizationIdCredentialsRequest) (*GetOrganizationOrganizationIdCredentials200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *GetOrganizationOrganizationIdCredentials200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultAPIService.GetOrganizationOrganizationIdCredentials")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
