...
*/
func (a *DefaultAPIService) GetClusterLogs(ctx context.Context, clusterId string) ApiGetClusterLogsRequest {
	return ApiGetClusterLogsRequest{
		ApiService: a,
		ctx:        ctx,
		clusterId:  clusterId,
...
func (a *DefaultAPIService) GetClusterLogsExecute(r ApiGetClusterLogsRequest) (*ClusterLogsResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultAPIService.GetClusterLogs")
	if err != nil {
