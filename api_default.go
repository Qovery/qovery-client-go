...
*/
func (a *DefaultAPIService) GetEnvironmentDeploymentQueue(ctx context.Context, environmentId string) ApiGetEnvironmentDeploymentQueueRequest {
	return ApiGetEnvironmentDeploymentQueueRequest{
		ApiService:    a,
		ctx:           ctx,
...
func (a *DefaultAPIService) GetEnvironmentDeploymentQueueExecute(r ApiGetEnvironmentDeploymentQueueRequest) (*QueuedDeploymentRequestWithStages, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultAPIService.GetEnvironmentDeploymentQueue")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *DefaultAPIService) ListServicesByOrganizationId(ctx context.Context, organizationId string) ApiListServicesByOrganizationIdRequest {
	return ApiListServicesByOrganizationIdRequest{
		ApiService:     a,
		ctx:            ctx,
...
func (a *DefaultAPIService) ListServicesByOrganizationIdExecute(r ApiListServicesByOrganizationIdRequest) (*ListServicesByOrganizationId200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultAPIService.ListServicesByOrganizationId")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
