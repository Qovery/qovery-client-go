...
// If true, returns a short-lived token for the qovery-readonly ServiceAccount (bound to view ClusterRole) generated by the cluster-agent
func (r ApiGetClusterTokenByClusterIdRequest) ReadOnly(readOnly bool) ApiGetClusterTokenByClusterIdRequest {
	r.readOnly = &readOnly
	return r
}
