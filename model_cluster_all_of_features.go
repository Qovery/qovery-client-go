...
// ClusterAllOfFeatures struct for ClusterAllOfFeatures
type ClusterAllOfFeatures struct {
	...
	Value               NullableOneOfstringboolean `json:"value,omitempty"`
...
func (o *ClusterAllOfFeatures) SetDescriptionNil() {
...
func (o *ClusterAllOfFeatures) SetCostPerMonthInCentsNil() {
...
func (o *ClusterAllOfFeatures) SetCostPerMonthNil() {
...
// SetValue gets a reference to the given NullableOneOfstringboolean and assigns it to the Value field.
func (o *ClusterAllOfFeatures) SetValue(v OneOfstringboolean) {
	o.Value.Set(&v)
}

// SetValueNil sets the value for Value to be an explicit nil
func (o *ClusterAllOfFeatures) SetValueNil() {
	o.Value.Set(nil)
}
...
func (o ClusterAllOfFeatures) MarshalJSON() ([]byte, error) {
...
type NullableClusterAllOfFeatures struct {
	value *ClusterAllOfFeatures
	isSet bool
}

func (v NullableClusterAllOfFeatures) Get() *ClusterAllOfFeatures {
	return v.value
}

func (v *NullableClusterAllOfFeatures) Set(val *ClusterAllOfFeatures) {
	v.value = val
	v.isSet = true
}

func (v NullableClusterAllOfFeatures) IsSet() bool {
	return v.isSet
}

func (v *NullableClusterAllOfFeatures) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClusterAllOfFeatures(val *ClusterAllOfFeatures) *NullableClusterAllOfFeatures {
	return &NullableClusterAllOfFeatures{value: val, isSet: true}
}

func (v NullableClusterAllOfFeatures) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClusterAllOfFeatures) UnmarshalJSON(src []byte) error {
	v.isSet = true
