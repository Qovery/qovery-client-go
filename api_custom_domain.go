...
*/
func (a *CustomDomainAPIService) CreateHelmCustomDomain(ctx context.Context, helmId string) ApiCreateHelmCustomDomainRequest {
	return ApiCreateHelmCustomDomainRequest{
		ApiService: a,
		ctx:        ctx,
		helmId:     helmId,
...
// Execute executes the request
//  @return CustomDomain
func (a *CustomDomainAPIService) CreateHelmCustomDomainExecute(r ApiCreateHelmCustomDomainRequest) (*CustomDomain, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CustomDomainAPIService.CreateHelmCustomDomain")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *CustomDomainAPIService) ListHelmCustomDomain(ctx context.Context, helmId string) ApiListHelmCustomDomainRequest {
	return ApiListHelmCustomDomainRequest{
		ApiService: a,
		ctx:        ctx,
		helmId:     helmId,
...
// Execute executes the request
//  @return CustomDomainResponseList
func (a *CustomDomainAPIService) ListHelmCustomDomainExecute(r ApiListHelmCustomDomainRequest) (*CustomDomainResponseList, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CustomDomainAPIService.ListHelmCustomDomain")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
