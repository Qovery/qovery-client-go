...
type ApiGetOrganizationBitbucketRepositoriesTempRequest struct {
	ctx            context.Context
	ApiService     *OrganizationAccountGitRepositoriesAPIService
	organizationId string
	gitTokenId     *string
...
// The git token id that must be used for the application
func (r ApiGetOrganizationBitbucketRepositoriesTempRequest) GitTokenId(gitTokenId string) ApiGetOrganizationBitbucketRepositoriesTempRequest {
	r.gitTokenId = &gitTokenId
	return r
}

func (r ApiGetOrganizationBitbucketRepositoriesTempRequest) Execute() (*GitRepositoryResponseList, *http.Response, error) {
	return r.ApiService.GetOrganizationBitbucketRepositoriesTempExecute(r)
}

/*
GetOrganizationBitbucketRepositoriesTemp Get bitbucket repositories of the connected user

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param organizationId Organization ID
 @return ApiGetOrganizationBitbucketRepositoriesTempRequest
*/
func (a *OrganizationAccountGitRepositoriesAPIService) GetOrganizationBitbucketRepositoriesTemp(ctx context.Context, organizationId string) ApiGetOrganizationBitbucketRepositoriesTempRequest {
	return ApiGetOrganizationBitbucketRepositoriesTempRequest{
		ApiService:     a,
		ctx:            ctx,
		organizationId: organizationId,
...
// Execute executes the request
//  @return GitRepositoryResponseList
func (a *OrganizationAccountGitRepositoriesAPIService) GetOrganizationBitbucketRepositoriesTempExecute(r ApiGetOrganizationBitbucketRepositoriesTempRequest) (*GitRepositoryResponseList, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OrganizationAccountGitRepositoriesAPIService.GetOrganizationBitbucketRepositoriesTemp")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/organization/{organizationId}/account/bitbucket/repositoryTemp"
	localVarPath = strings.Replace(localVarPath, "{"+"organizationId"+"}", url.PathEscape(parameterValueToString(r.organizationId, "organizationId")), -1)
...
type ApiGetOrganizationGitProviderAccountTempRequest struct {
	ctx            context.Context
	ApiService     *OrganizationAccountGitRepositoriesAPIService
	organizationId string
}

func (r ApiGetOrganizationGitProviderAccountTempRequest) Execute() (*GitAuthProviderResponseList, *http.Response, error) {
	return r.ApiService.GetOrganizationGitProviderAccountTempExecute(r)
}

/*
GetOrganizationGitProviderAccountTemp Get git provider accounts

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param organizationId Organization ID
 @return ApiGetOrganizationGitProviderAccountTempRequest
*/
func (a *OrganizationAccountGitRepositoriesAPIService) GetOrganizationGitProviderAccountTemp(ctx context.Context, organizationId string) ApiGetOrganizationGitProviderAccountTempRequest {
	return ApiGetOrganizationGitProviderAccountTempRequest{
		ApiService:     a,
		ctx:            ctx,
		organizationId: organizationId,
...
// Execute executes the request
//  @return GitAuthProviderResponseList
func (a *OrganizationAccountGitRepositoriesAPIService) GetOrganizationGitProviderAccountTempExecute(r ApiGetOrganizationGitProviderAccountTempRequest) (*GitAuthProviderResponseList, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OrganizationAccountGitRepositoriesAPIService.GetOrganizationGitProviderAccountTemp")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/organization/{organizationId}/account/gitAuthProviderTemp"
	localVarPath = strings.Replace(localVarPath, "{"+"organizationId"+"}", url.PathEscape(parameterValueToString(r.organizationId, "organizationId")), -1)
...
type ApiGetOrganizationGithubRepositoriesTempRequest struct {
	ctx            context.Context
	ApiService     *OrganizationAccountGitRepositoriesAPIService
	organizationId string
	gitTokenId     *string
...
// The git token id that must be used for the application
func (r ApiGetOrganizationGithubRepositoriesTempRequest) GitTokenId(gitTokenId string) ApiGetOrganizationGithubRepositoriesTempRequest {
	r.gitTokenId = &gitTokenId
	return r
}

func (r ApiGetOrganizationGithubRepositoriesTempRequest) Execute() (*GitRepositoryResponseList, *http.Response, error) {
	return r.ApiService.GetOrganizationGithubRepositoriesTempExecute(r)
}

/*
GetOrganizationGithubRepositoriesTemp Get github repositories of the connected user

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param organizationId Organization ID
 @return ApiGetOrganizationGithubRepositoriesTempRequest
*/
func (a *OrganizationAccountGitRepositoriesAPIService) GetOrganizationGithubRepositoriesTemp(ctx context.Context, organizationId string) ApiGetOrganizationGithubRepositoriesTempRequest {
	return ApiGetOrganizationGithubRepositoriesTempRequest{
		ApiService:     a,
		ctx:            ctx,
		organizationId: organizationId,
...
// Execute executes the request
//  @return GitRepositoryResponseList
func (a *OrganizationAccountGitRepositoriesAPIService) GetOrganizationGithubRepositoriesTempExecute(r ApiGetOrganizationGithubRepositoriesTempRequest) (*GitRepositoryResponseList, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OrganizationAccountGitRepositoriesAPIService.GetOrganizationGithubRepositoriesTemp")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/organization/{organizationId}/account/github/repositoryTemp"
	localVarPath = strings.Replace(localVarPath, "{"+"organizationId"+"}", url.PathEscape(parameterValueToString(r.organizationId, "organizationId")), -1)
...
type ApiGetOrganizationGitlabRepositoriesTempRequest struct {
	ctx            context.Context
	ApiService     *OrganizationAccountGitRepositoriesAPIService
	organizationId string
	gitTokenId     *string
...
// The git token id that must be used for the application
func (r ApiGetOrganizationGitlabRepositoriesTempRequest) GitTokenId(gitTokenId string) ApiGetOrganizationGitlabRepositoriesTempRequest {
	r.gitTokenId = &gitTokenId
	return r
}

func (r ApiGetOrganizationGitlabRepositoriesTempRequest) Execute() (*GitRepositoryResponseList, *http.Response, error) {
	return r.ApiService.GetOrganizationGitlabRepositoriesTempExecute(r)
}

/*
GetOrganizationGitlabRepositoriesTemp Get gitlab repositories of the connected user

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param organizationId Organization ID
 @return ApiGetOrganizationGitlabRepositoriesTempRequest
*/
func (a *OrganizationAccountGitRepositoriesAPIService) GetOrganizationGitlabRepositoriesTemp(ctx context.Context, organizationId string) ApiGetOrganizationGitlabRepositoriesTempRequest {
	return ApiGetOrganizationGitlabRepositoriesTempRequest{
		ApiService:     a,
		ctx:            ctx,
		organizationId: organizationId,
...
// Execute executes the request
//  @return GitRepositoryResponseList
func (a *OrganizationAccountGitRepositoriesAPIService) GetOrganizationGitlabRepositoriesTempExecute(r ApiGetOrganizationGitlabRepositoriesTempRequest) (*GitRepositoryResponseList, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OrganizationAccountGitRepositoriesAPIService.GetOrganizationGitlabRepositoriesTemp")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/organization/{organizationId}/account/gitlab/repositoryTemp"
	localVarPath = strings.Replace(localVarPath, "{"+"organizationId"+"}", url.PathEscape(parameterValueToString(r.organizationId, "organizationId")), -1)
