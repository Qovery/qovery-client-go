...
var _ MappedNullable = &HelmGitRepositoryRequest{}

// HelmGitRepositoryRequest struct for HelmGitRepositoryRequest
type HelmGitRepositoryRequest struct {
...
func (o HelmGitRepositoryRequest) ToMap() (map[string]interface{}, error) {
...
func (o *HelmGitRepositoryRequest) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varHelmGitRepositoryRequest)
...
type NullableHelmGitRepositoryRequest struct {
	value *HelmGitRepositoryRequest
	isSet bool
}

func (v NullableHelmGitRepositoryRequest) Get() *HelmGitRepositoryRequest {
	return v.value
}

func (v *NullableHelmGitRepositoryRequest) Set(val *HelmGitRepositoryRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableHelmGitRepositoryRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableHelmGitRepositoryRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHelmGitRepositoryRequest(val *HelmGitRepositoryRequest) *NullableHelmGitRepositoryRequest {
	return &NullableHelmGitRepositoryRequest{value: val, isSet: true}
}

func (v NullableHelmGitRepositoryRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHelmGitRepositoryRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
