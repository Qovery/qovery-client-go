...
type ApiListHelmDeploymentHistoryV2Request struct {
	ctx        context.Context
	ApiService *HelmDeploymentHistoryAPIService
	helmId     string
}
...
func (r ApiListHelmDeploymentHistoryV2Request) Execute() (*DeploymentHistoryServicePaginatedResponseListV2, *http.Response, error) {
	return r.ApiService.ListHelmDeploymentHistoryV2Execute(r)
}
...
func (a *HelmDeploymentHistoryAPIService) ListHelmDeploymentHistoryV2Execute(r ApiListHelmDeploymentHistoryV2Request) (*DeploymentHistoryServicePaginatedResponseListV2, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "HelmDeploymentHistoryAPIService.ListHelmDeploymentHistoryV2")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/helm/{helmId}/deploymentHistoryV2"
	localVarPath = strings.Replace(localVarPath, "{"+"helmId"+"}", url.PathEscape(parameterValueToString(r.helmId, "helmId")), -1)
