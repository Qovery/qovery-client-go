...
type ApiListTerraformVersionsRequest struct {
	ctx        context.Context
	ApiService *TerraformMainCallsAPIService
}

func (r ApiListTerraformVersionsRequest) Execute() (*TerraformVersionResponseList, *http.Response, error) {
	return r.ApiService.ListTerraformVersionsExecute(r)
}

/*
ListTerraformVersions List available Terraform versions

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiListTerraformVersionsRequest
*/
func (a *TerraformMainCallsAPIService) ListTerraformVersions(ctx context.Context) ApiListTerraformVersionsRequest {
	return ApiListTerraformVersionsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
//
//	@return TerraformVersionResponseList
func (a *TerraformMainCallsAPIService) ListTerraformVersionsExecute(r ApiListTerraformVersionsRequest) (*TerraformVersionResponseList, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *TerraformVersionResponseList
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TerraformMainCallsAPIService.ListTerraformVersions")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
