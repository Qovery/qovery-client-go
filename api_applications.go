...
*/
func (a *ApplicationsApiService) DeployAllApplications(ctx context.Context, environmentId string) ApiDeployAllApplicationsRequest {
	return ApiDeployAllApplicationsRequest{
		ApiService:    a,
		ctx:           ctx,
		environmentId: environmentId,
...
// Execute executes the request
//  @return Status
func (a *ApplicationsApiService) DeployAllApplicationsExecute(r ApiDeployAllApplicationsRequest) (*Status, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ApplicationsApiService.DeployAllApplications")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *ApplicationsApiService) DeployAllServices(ctx context.Context, environmentId string) ApiDeployAllServicesRequest {
	return ApiDeployAllServicesRequest{
		ApiService:    a,
		ctx:           ctx,
		environmentId: environmentId,
...
// Execute executes the request
//  @return Status
func (a *ApplicationsApiService) DeployAllServicesExecute(r ApiDeployAllServicesRequest) (*Status, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ApplicationsApiService.DeployAllServices")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
