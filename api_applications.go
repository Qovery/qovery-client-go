...
*/
func (a *ApplicationsApiService) GetDefaultClusterAdvancedSettings(ctx context.Context) ApiGetDefaultClusterAdvancedSettingsRequest {
	return ApiGetDefaultClusterAdvancedSettingsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *ApplicationsApiService) GetDefaultClusterAdvancedSettingsExecute(r ApiGetDefaultClusterAdvancedSettingsRequest) (*ClusterAdvancedSettings, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ApplicationsApiService.GetDefaultClusterAdvancedSettings")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
